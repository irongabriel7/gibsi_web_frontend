  ...
  return (
    <div className="gibsi-about-bg">
      ...
      <div className="gibsi-content">
        ...
        <h2 className="slogan">Unlock Tomorrow’s Markets</h2>
        <p className="about-text">
          <span className="highlight">GIBSI</span> connects next-gen machine learning with the real pulse of the stock market. <br /><br />
          <span className="quote">“When data meets intuition, future profits are no longer guesswork—they’re engineered.”</span><br /><br />
          Our journey:<br />
          <span className="mission">Empowering traders to find and act on signals hidden within intraday volatility and technical indicators—with room for human adjustment and feedback.</span>
          <br /><br />
          ...
          <span className="section-title">Join GIBSI:</span><br />
          Trade, learn, and explore new possibilities in modern finance.
        </p>
